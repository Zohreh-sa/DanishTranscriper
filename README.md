...
Audio is checked every 3 seconds. Quiet chunks are ignored instead of being sent to Whisper, and an immediate duplicate result is discarded. This prevents silence from repeatedly adding the last sentence to the transcript.
